...
html += '    @media (max-width: 991.98px) {\n'
html += '      .pagination {\n'
html += '        --bs-pagination-padding-x: 0.5rem;\n'
html += '        --bs-pagination-padding-y: 0.25rem;\n'
html += '        --bs-pagination-font-size: 0.875rem;\n'
html += '      }\n'
html += '      .page-link {\n'
html += '        padding: var(--bs-pagination-padding-y) var(--bs-pagination-padding-x);\n'
html += '        font-size: var(--bs-pagination-font-size);\n'
html += '      }\n'
html += '      /* 在中屏幕上始终显示：第一页、最后一页、当前页、省略号 */\n'
html += '      .page-item:not(:first-child):not(:last-child):not(.active):not(:has(.page-link:contains("..."))) {\n'
html += '        display: none;\n'
html += '      }\n'
html += '      .page-item:first-child,\n'  # 上一页
html += '      .page-item:last-child,\n'   # 下一页
html += '      .page-item.active,\n'       # 当前页
html += '      .page-item:has(.page-link:contains("1")),\n'  # 第一页
html += '      .page-item:has(.page-link:contains("...")),\n' # 省略号
html += '      .page-item:has(.page-link:contains("'+str(total_pages)+'")) { display: block !important; }\n'  # 最后一页
html += '    }\n'
html += '    @media (max-width: 767.98px) {\n'
html += '      .pagination {\n'
html += '        --bs-pagination-padding-x: 0.375rem;\n'
html += '        --bs-pagination-padding-y: 0.125rem;\n'
html += '        --bs-pagination-font-size: 0.75rem;\n'
html += '      }\n'
html += '      /* 在小屏幕上确保显示：上一页、下一页、第一页、最后一页、当前页、省略号 */\n'
html += '      .page-item:not(:first-child):not(:last-child):not(.active):not(:has(.page-link:contains("1"))):not(:has(.page-link:contains("'+str(total_pages)+'"))):not(:has(.page-link:contains("..."))) {\n'
html += '        display: none;\n'
html += '      }\n'
html += '      .page-item:first-child,\n'  # 上一页
html += '      .page-item:last-child,\n'   # 下一页
